    ...
    <div class="d-flex align-items-center justify-content-center ht-100v">
      ...
      <div class="overlay-body bg-black-7 d-flex align-items-center justify-content-center">
        <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 rounded bg-black-6">
          <div class="signin-logo tx-center tx-28 tx-bold tx-white"><span class="tx-normal">[</span> SING <span class="tx-info">IN</span> <span class="tx-normal">]</span></div>
          <div class="tx-white-5 tx-center mg-b-60">Admin Dashboard</div>
          <?php
          if(isset($_SESSION['login_err'])){
            echo '<div class ="alart alart-denger">';
